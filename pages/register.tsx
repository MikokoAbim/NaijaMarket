...
export default function Register() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <Head>
        <title>Register | Nigerian AI Market</title>
        <meta name="description" content="Create a new account on Nigerian AI Market to start shopping." />
      </Head>
          ...
          <div className="max-w-md mx-auto">
            <div className="bg-white rounded-xl shadow-md overflow-hidden p-8">
              <div className="text-center mb-8">
                <h1 className="text-2xl font-bold mb-2 font-display">Create Account</h1>
                <p className="text-gray-600">Join Nigerian AI Market to start shopping</p>
              </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3 text-sm">
                    <label htmlFor="agreeToTerms" className="text-gray-700">
                      I agree to the{' '}
                      <Link href="/terms" className="text-nigerian-green hover:text-ankara-green">
                        Terms and Conditions
                      </Link>{' '}
                      and{' '}
                      <Link href="/privacy" className="text-nigerian-green hover:text-ankara-green">
                        Privacy Policy
                      </Link>
                    </label>
                  </div>
